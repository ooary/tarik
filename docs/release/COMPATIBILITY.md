...
- metadata SQLite schema version 7;
...
Metadata contains project registrations, editor sessions/drafts, saved queries, query/export history, source records, and preferences. Result caches and logs are not required to restore projects.
